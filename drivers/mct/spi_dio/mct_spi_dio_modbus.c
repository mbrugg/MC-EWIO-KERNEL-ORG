...
#include "mct_spi_dio_modbus_cmd.h"
#include "mct_spi_dio_modbus_cfg.h"
#include "../if/modbus_if.h"
#include "../if/modbus_app.h"

//#include "mct_spi_dio_modbus_test.h"	// TEST-Sequencen

/// MODBUS-PLATTFORM DEVICE - Zeiger
static struct platform_device * pdev;
/// MODBUS-DEVICE Interface Name
char dio_dev_if_modbus[100];

static DECLARE_COMPLETION( modbus_device_is_free );

/// la (typ: mod_app) mit Zeiger auf dio_O_Mct (typ:tdio_drv)
...
//	.fake_line	= &MODBUS_TLGs[0],
	...
	.slvs[MODBUS_SLV_0].pri_addr	=  MODBUS_RTU_TO_INTERN_BASE_ADDR + DRIVER_PIN_DIO_IDENT_NUM * 10,
	.cmd_rsp_01						= dio_mod_sl2_cmd_rsp_01,
	.cmd_rsp_02						= dio_mod_sl2_cmd_rsp_02,	
	.cmd_rsp_05						= dio_mod_sl2_cmd_rsp_05,	
	.cmd_rsp_15						= dio_mod_sl2_cmd_rsp_15,
	.cmd_rsp_mei_14_code			= dio_mod_sl2_cmd_rsp_mei_14_code,
	.pdata							= &dio_O_Mct,
	},	
};
...
int  modbus_build(struct platform_driver * drv,unsigned char slot) {	
	...
	/// INTERFACE-NAME
	strcpy(dio_dev_if_modbus,MODBUS_DEVICE_INTERFACE);
	slotstr[0]= slot +0x30;
	strcat(dio_dev_if_modbus,slotstr);
	pdev = platform_device_alloc(dio_dev_if_modbus,0);
