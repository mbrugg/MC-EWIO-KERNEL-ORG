/*********************************************************************************
	...
	$Date:$ 	01.09.2011
 	...
 	Description: MBUS-Command-Implemetation for mct_paa_ai8-Driver

	Reset-Subcodes:	- APPLICATION_RESET_USER_DATA

 *******************************************************************************/
#ifndef MCT_PAA_AI8_MBUS_CMD_H_
	#define MCT_PAA_AI8_MBUS_CMD_H_
