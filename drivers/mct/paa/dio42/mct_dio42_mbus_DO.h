/*********************************************************************************
	...
	M-BUS GERÄT:	1	(index=1)
				
	BINARY_1	(OUTPUT)-Register (Storage0, == 2 digitale Ausgänge)
		- read		(Register lesen)
 ...
 *******************************************************************************/
#ifndef MCT_PAA_DIO42_MBUS_DO_H_
	#define MCT_PAA_DIO42_MBUS_DO_H_
...
#endif	//MCT_PAA_DIO42_MBUS_DO_H_