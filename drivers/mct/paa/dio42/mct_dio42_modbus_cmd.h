 ...
 *******************************************************************************/
#ifndef MCT_PAA_DIO42_MODBUS_CMD_H_
	#define MCT_PAA_DIO42_MODBUS_CMD_H_
...
extern int dio42_mod_sl2_cmd_rsp_01(struct mod_l2 * l2);

// Hinweis:
// Es werden die Zustände der Eingänge (0-3) gelesen.
extern int dio42_mod_sl2_cmd_rsp_02(struct mod_l2 * l2);
...
extern int dio42_mod_sl2_cmd_rsp_05(struct mod_l2 * l2);
...
extern int dio42_mod_sl2_cmd_rsp_15(struct mod_l2 * l2);


extern int dio42_mod_sl2_cmd_rsp_mei_14_code(struct mod_l2 * l2, unsigned char code);

#endif	//MCT_PAA_DIO42_MODBUS_CMD_H_