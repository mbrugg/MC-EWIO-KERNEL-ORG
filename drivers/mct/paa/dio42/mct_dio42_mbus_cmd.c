/*********************************************************************************
	...
	$Date:$ 	31.08.2011
 	...
 	Description: MBUS-Command-Implementation for mct_paa_dio42-Driver

 *******************************************************************************/
#include "mct_dio42_objs.h"		// objects

#include "mct_dio42_mbus_cfg.h"		// Konfiguration
#include "mct_dio42_mbus_DI.h"		// Gerät:0 mit 4 digitalen Eingängen
#include "mct_dio42_mbus_DO.h"		// Gerät:1 mit 2 digitalen Ausgängen + Handmaske
...
{
	CREATE_DRV_PTR;
	CREATE_IDEV_PTR;	// ist initialisiert! 
...
/// ------------------------------------------------------------------
/// SND_UD_VAR_DATA (OVERLOADED) Multi-Modul 
/// ------------------------------------------------------------------
