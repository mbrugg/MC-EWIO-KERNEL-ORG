...
#include "mct_dio42_modbus_cmd.h"
#include "mct_dio42_modbus_cfg.h"
#include "../../if/modbus_if.h"
#include "../../if/modbus_app.h"
//#include "mct_dio42_modbus_test.h"	// TEST-Sequencen

/// MODBUS-PLATTFORM DEVICE - Zeiger
static struct platform_device * pdev;
/// MODBUS-DEVICE Interface Name
char dio42_dev_if_modbus[100];

static DECLARE_COMPLETION( modbus_device_is_free );

/// la (typ: mod_app) mit Zeiger auf doi42_O_Mct (typ:tdio42_drv)
...
//	.fake_line	= &TLGs[0],
	...
	.slvs[MODBUS_SLV_0].pri_addr	= MODBUS_RTU_TO_LBUS_BASE_ADDR + DRIVER_PAA_DIO42_IDENT_NUM,
	.cmd_rsp_01						= dio42_mod_sl2_cmd_rsp_01,
	.cmd_rsp_02						= dio42_mod_sl2_cmd_rsp_02,	
	.cmd_rsp_05						= dio42_mod_sl2_cmd_rsp_05,	
	.cmd_rsp_15						= dio42_mod_sl2_cmd_rsp_15,
	.cmd_rsp_mei_14_code			= dio42_mod_sl2_cmd_rsp_mei_14_code,
	.pdata							= &dio42_O_Mct,
	},	
};
