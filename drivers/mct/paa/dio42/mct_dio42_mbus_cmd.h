/*********************************************************************************
	...
	$Date:$		31.08.2011
 	...
 	Description: MBUS-Command-Implemetation for mct_paa_dio42-Driver

	Reset-Subcodes:	- APPLICATION_RESET_USER_DATA

*******************************************************************************/
#ifndef MCT_PAA_DIO42_MBUS_CMD_H_
	#define MCT_PAA_DIO42_MBUS_CMD_H_
...
/// Hinweise:
//	Es werden hier variable Datenstrukturen erwartet die ab DIF1-Feld 
...
#endif	//MCT_PAA_DIO42_MBUS_CMD_H_