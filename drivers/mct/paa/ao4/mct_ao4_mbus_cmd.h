/*********************************************************************************
	...
	$Date:$ 	02.09.2011
 	...
 	Description: MBUS-Command-Implemetation for mct_paa_ao4-Driver

	Reset-Subcodes:	- APPLICATION_RESET_USER_DATA

 *******************************************************************************/
#ifndef MCT_PAA_AO4_MBUS_CMD_H_
	#define MCT_PAA_AO4_MBUS_CMD_H_
