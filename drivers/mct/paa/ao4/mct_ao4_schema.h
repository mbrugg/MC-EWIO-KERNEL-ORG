...
*********************************************************************************/
#define UUID_SCHEMATA	"71760b00-c7b0-11df-bd3b-0800200c9a60"
...
#define JSON_SCHEMA_PAA_AO4_EN "{\
\"uuid\":"QUO(UUID_SCHEMATA)",\
\"type\":\"object\",\
\"description\":\"ao4 paa-client-driver (analog O-driver)\",\
\"properties\":\
{\
"QUO(OBJECT_DRIVER_S)":\
{\
...
\"items\":\
{\
\"description\":\"ao4 paa-client-port (analog O-port)\",\
\"properties\":\
{\
"QUO(PROPERTY_NAME_S)":\
{\
