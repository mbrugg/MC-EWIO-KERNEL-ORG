/*********************************************************************************
	...
	$Date:$		30.08.2011
 	...
 	Description: MBUS-Command-Implemetation for mct_paa_do4-Driver

	Reset-Subcodes:	- APPLICATION_RESET_USER_DATA

 *******************************************************************************/
#ifndef MCT_PAA_DO4_MBUS_CMD_H_
	#define MCT_PAA_DO4_MBUS_CMD_H_
