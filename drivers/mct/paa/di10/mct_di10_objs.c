...
/// TEMPLATES
///*********************************************************
struct t_dig DIs[DEV_MCT_PAA_DI10_IN_CHAN_MAX] = {
		{"DI1 (1/C1)",SIZE_VALUE1,"0x0001"},
		{"DI2 (2/C1)",SIZE_VALUE1,"0x0002"},	
		{"DI3 (3/C1)",SIZE_VALUE1,"0x0004"},	
		{"DI4 (4/C1)",SIZE_VALUE1,"0x0008"},	
		{"DI5 (5/C1)",SIZE_VALUE1,"0x0010"},	
		{"DI6 (6/C1)",SIZE_VALUE1,"0x0020"},	
		{"DI7 (7/C1)",SIZE_VALUE1,"0x0040"},	
		{"DI8 (8/C1)",SIZE_VALUE1,"0x0080"},	
		{"DI9 (9/C1)",SIZE_VALUE1,"0x0100"},	
		{"DI10 (10/C1)",SIZE_VALUE1,"0x0200"}	
};
...
///*********************************************************
// DRIVER-ARG's
char			di10_json[JSON_LIMIT_SIZE];	// JSON formatierte Eingabe
...
STATIC char 	in_name_8[PROPERTY_SIZE+1];
STATIC char 	in_name_9[PROPERTY_SIZE+1];

// QUEUE mit in-name Zeigern 
STATIC  char * const  in_name_queue[DEV_MCT_PAA_DI10_IN_CHAN_MAX] = 	\
{	in_name_0,in_name_1,in_name_2,in_name_3,in_name_4,	\
	in_name_5,in_name_6,in_name_7,in_name_8,in_name_9,};
...
//		.value	=  hier nicht verwendet!
	...
	.P_Size = {	// Verarbeitungsbreite
		...
		.value	= (unsigned char) DEV_MCT_PAA_DI10_IN_CHAN_MAX,
	},
	.P_Value = {
...
/// Devive
struct tdi10_dev_inp di10_O_Inputs = {
	.Op_Value	= &O_ValuesIn,
}; 

/// Driver
struct 	tdi10_drv di10_O_Mct = {
	.Op_Control = &O_Control,
	.Op_Physic = &O_Physic,
	.Op_Inputs = &di10_O_Inputs,
};
...
void di10_objects_generic(void) {	
	...
	if(command == e_start || command == e_stop)	{		// ARG: "command" übernehmen
		di10_O_Mct.Op_Control->P_Control.value[0] = command; // Hinweis: Ein Externes Kommando wird auf [0] geschrieben,
		di10_O_Mct.Op_Control->P_Control.value[1] = command;	// während die internen Stati in [1] stehen
	}
	/// *** Properties IN_NAME_x laden
	for	(_idx= 0; _idx < DEV_MCT_PAA_DI10_IN_CHAN_MAX; _idx++){ // ARGS: "in_name_x" übernehmen, wenn Eintrag!
...
//				{
//				oDevices[0]oValues[0-9].Name 				==> in_name_queue_[0-9]
//				}
//				Anschließend wird di10_objects_generic() aufgerufen - und die Eingabe-
//				parameter zum Teil kontrolliert. Je nach Wichtigkeit erfolgt eine
//				genaue Überprüfung oder z.B. nur der Längencheck.
//  
//************************************************************************************ 
ssize_t di10_objects_json(const char  * json) {
	JsonDecode_State D;
	elivator  		ctx;
	...
	///------------------
	/// NAME
	for (_ch= 0; _ch < DEV_MCT_PAA_DI10_IN_CHAN_MAX; _ch++)	{
...
///*********************************************************
module_param_string	( json, di10_json, sizeof(di10_json), S_IRUGO);	
...
module_param_string( in_name_8, in_name_8, sizeof(in_name_8), S_IRUGO);
module_param_string( in_name_9, in_name_9, sizeof(in_name_9), S_IRUGO);
