/*********************************************************************************
	...
	$Date:$		25.08.2011
 	...
 	Description:  MBUS-Command-Implementation for mct_paa_di10-Driver
	
 *******************************************************************************/
#include "mct_di10_objs.h"			// objects

#include "mct_di10_mbus_cfg.h"		// Konfiguration
#include "mct_di10_mbus_DI.h"		// Gerät:1 mit digitalen Eingängen
