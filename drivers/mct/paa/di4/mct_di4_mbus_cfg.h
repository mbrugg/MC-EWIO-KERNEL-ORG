/*********************************************************************************
	...
	Description: MBUS-Configuration for mct_paa_di4-Driver
	...
	Sec-Adressen:	x=SLOT 0...5: (unterstützt 1 virtuelles MBUS-Modul)
					000003x0 == MBUS-Modul (4 dig. Eingänge)

	Geräte-Object  mct_if.01.2-3-SLOT.0
	[mct] 		= MC Technology
	[if]  		= Interface
	[.01] 		= 1 Gerät
	[.2-3]		= MBUS, Treiberkennung mct_paa_di4
	[-SLOT]		= 0...5
	.0			= Instanz

*********************************************************************************/
#ifndef __MCT_MBUS_PAA_DI4_CFG_H_
	#define __MCT_MBUS_PAA_DI4_CFG_H_	

#define MBUS_DEVICE_INTERFACE	"mct_" DRIVER_INTERFACE ".01." BUS_MBUS "-" DRIVER_PAA_DI4_IDENT "-"
