...
*********************************************************************************/
#ifndef MCT_DI4_OBJS_H_
	#define MCT_DI4_OBJS_H_
...
#define DEV_MCT_PAA_DI4_IN_MAX			1	// IN-Geräte
#define DEV_MCT_PAA_DI4_IN_CHAN_MAX		4	// IN-Kanäle pro IN-Gerät

#define DEV_MCT_PAA_DI4_IN_CHAN_0		0
#define DEV_MCT_PAA_DI4_IN_CHAN_1		1
#define DEV_MCT_PAA_DI4_IN_CHAN_2		2
#define DEV_MCT_PAA_DI4_IN_CHAN_3		3
...
struct tdi4_dev_inp {				// Input-Object
	char *				pname;
	obj_value  * 		Op_Value;
};
...
struct tdi4_drv {
	...
	di4_control			* 	ct;						// Slot:  globale Steuerung	
	obj_physic	 		* 	Op_Physic;				// Slot:  Physic-Object	
	struct tdi4_dev_inp * 	Op_Inputs;
};
...
#define OBJS_CREATE_DRV_PTR(access) struct tdi4_drv *drv = (struct tdi4_drv *)(access)
// input-device
#define OBJS_CREATE_IDEV_PTR		struct tdi4_dev_inp  *idev = drv->Op_Inputs
...
///*********************************************************
// DRIVER-ARG's
extern char					di4_json[JSON_LIMIT_SIZE];

///*********************************************************
///  OBJECT's	(Driver, Devices) 
///*********************************************************
extern struct tdi4_drv 		di4_O_Mct;								// Driver Object
extern struct tdi4_dev_inp 	di4_O_Inputs;							// Device Input Object
///*********************************************************
///  TEMPLATE's
///*********************************************************
...
///  FUNCTION's
///*********************************************************
extern void 	di4_objects_generic(void);
extern ssize_t 	di4_objects_json(const char *);
