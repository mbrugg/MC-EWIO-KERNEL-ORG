/*********************************************************************************
	...
	Description: MODBUS-Configuration for mct_paa_di4-Driver
	...
	[if]  		= Interface
	[.01] 		= 1 Gerät
	[.3-3]		= MODBUS, Treiberkennung mct_paa_di4
	[-SLOT]		= 0...5
	.0		= Instanz

*********************************************************************************/
#ifndef __MCT_MODBUS_PAA_DI4_CFG_H_
	#define __MCT_MODBUS_PAA_DI4_CFG_H_	

#define MODBUS_DEVICE_INTERFACE	"mct_" DRIVER_INTERFACE ".01." BUS_MODBUS "-" DRIVER_PAA_DI4_IDENT "-"
...
#define MODBUS_SLV_0		0	// Index  MOD-Bus Gerät 4 Eingänge
